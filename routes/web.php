...
// Public detail pages for home-page cards
$router->get('/programs/{id}', [App\Controllers\HomeController::class, 'programDetail']);
$router->get('/facilities/{id}', [App\Controllers\HomeController::class, 'facilityDetail']);
$router->get('/teachers/{id}', [App\Controllers\HomeController::class, 'teacherDetail']);
