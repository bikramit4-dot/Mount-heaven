...
// Everything else — app/, core/, config/, routes/, database/, storage/ —
// is never exposed, mirroring the Apache .htaccess rules so dev behaves
// exactly like live.
...
// it actually lives inside public/.
