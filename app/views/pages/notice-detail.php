...
<section class="section">
  <div class="container detail-grid">
    ...
    <article class="detail-main">
      <?php $bs = \App\Core\NepaliCalendar::adToBs((string) $notice['published_at']); ?>
      ...
      <div class="panel">
        ...
        <?php if ($notices): ?>
          <?php foreach ($notices as $n): ?>
            <?php $nBs = \App\Core\NepaliCalendar::adToBs((string) $n['published_at']); ?>
            <div class="side-item">
              <div class="side-date"><?= e(date('d M', strtotime($n['published_at']))) ?></div>
              <div>
                <a class="side-link" href="<?= url('/notices/' . (int) $n['id']) ?>"><?= e($n['title']) ?></a>
                <?php if ($nBs): ?><time class="side-bs"><?= e(\App\Core\NepaliCalendar::formatBsNp($nBs)) ?></time><?php endif; ?>
