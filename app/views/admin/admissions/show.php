...
<div class="admin-panel detail-panel">
  ...
  <table class="detail-table">
    ...
    <tr><th>Date of Birth</th><td><?php echo $enquiry['dob'] ? e(format_date($enquiry['dob'], 'M j, Y')) : '—'; ?><?php if (!empty($enquiry['dob_bs_label'])): ?> <span class="np">(<?= e($enquiry['dob_bs_label']) ?> B.S.)</span><?php endif; ?></td></tr>
    ...
    <tr><th>Previous Class</th><td><?php echo !empty($enquiry['previous_class']) ? e($enquiry['previous_class']) : '—'; ?></td></tr>
    <tr><th>EMIS Number</th><td><?php echo !empty($enquiry['emis_no']) ? e($enquiry['emis_no']) : '—'; ?></td></tr>
  </table>
