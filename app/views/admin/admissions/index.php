...
<?php foreach ($enquiries as $q): ?>
  <div class="admin-panel enquiry-card">
    ...
    <div class="enquiry-grid">
      ...
      <?php if (!empty($q['previous_class'])): ?><div><strong>Previous class:</strong> <?php echo e($q['previous_class']); ?></div><?php endif; ?>
      <?php if (!empty($q['emis_no'])): ?><div><strong>EMIS no:</strong> <?php echo e($q['emis_no']); ?></div><?php endif; ?>
